...
public class AFD 
{
    ...
    /**
     * M�todo para quitar los estados de trampa de un aut�mata
     * @param afd
    ...
    public Automata quitarEstadosTrampa(Automata afd){
        ...
        * y al final se elimina el estado del aut�mata
        */
        ...
        //3. arreglar la numeraci�n cuando se quita un estado
        for (int i = 0;i<afd.getEstados().size();i++){
    ...
    /**
     * Automata de prueba para comprobar la minimizaci�n
     * @return Automata
     */
